...
13. Once your subscription is selected, its time to select a naming prefix for your resources _(if you select Enter you can manually name each resource),_ in my case my prefix will be: _aoe_
