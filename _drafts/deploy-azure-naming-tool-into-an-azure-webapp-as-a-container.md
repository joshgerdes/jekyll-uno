...
16. Application Insights isn't required, but it is recommended _- even if its just for Availability alerting)_; I always enable it, so select **Yes** and **Next Tags.**
