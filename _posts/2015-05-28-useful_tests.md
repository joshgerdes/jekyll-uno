...
* Never have a whole site outage as a result of a deploy
* Scenarios are always viewable
* You can login
* Proposing a scenario always works
* Suggesting a tool always works
* Comments, pros and cons and votes are all usable
* noscript users get fully rendered pages (for SEO)
