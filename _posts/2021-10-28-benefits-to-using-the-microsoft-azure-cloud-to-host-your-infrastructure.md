...
\#ProTip - Resources such as the [Azure Total Cost of Ownership (TCO)](https://azure.microsoft.com/en-us/pricing/tco/calculator/ "Total Cost of Ownership (TCO) Calculator"){:target="_blank"} can help you calculate the true cost of your workloads.