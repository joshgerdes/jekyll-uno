...
Now that the Preview feature has been registered, we can now create a new Storage account.
 ...
 7. Select your storage account name _(_[_this needs to be globally unique and a maximum of 24 characters_](https://docs.microsoft.com/en-us/azure/azure-resource-manager/management/resource-name-rules?WT.mc_id=AZ-MVP-5004796#microsoftstorage "Naming rules and restrictions for Azure resources"){:target="_blank"}_), in my example; I am going with: sftpstorageacc1337_
