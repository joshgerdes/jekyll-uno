...
* You cannot use a Public IP Prefix that is in use by the NAT Gateway for any other workload, _ie any inbound Public IPs, you need to have another Public IP prefix resource._
...
8. This is where you can either create a Public IP prefix for use with your NAT Gateway
